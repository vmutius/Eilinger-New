    ...
    @foreach ($siblings as $index => $sibling)
        <div class="row g-3">
            <div class="col-sm-5">
                ...
                <input wire:model.blur="siblings.{{ $index }}.lastname" type="text" class="form-control" />
                <span class="text-danger">
                    @error('siblings.' . $index . '.lastname')
                        {{ $message }}
                    @enderror
                </span>
            </div>
            <div class="col-sm-5">
                ...
                <input wire:model.blur="siblings.{{ $index }}.firstname" type="text" class="form-control" />
                <span class="text-danger">
                    @error('siblings.' . $index . '.firstname')
                        {{ $message }}
                    @enderror
                </span>
            </div>
            <div class="col-sm-2">
                ...
                <input wire:model.blur="siblings.{{ $index }}.birth_year" type="number" class="form-control" />
                <span class="text-danger">
                    @error('siblings.' . $index . '.birth_year')
                        {{ $message }}
                    @enderror
                </span>
            </div>
            ...
            <div class="col-sm-12">
                ...
                <input wire:model.blur="siblings.{{ $index }}.place_of_residence" type="text"
                    class="form-control" />
                <span class="text-danger">
                    @error('siblings.' . $index . '.place_of_residence')
                        {{ $message }}
                    @enderror
                </span>
            </div>
            ...
            <div class="col-sm-4">
                ...
                <input wire:model.blur="siblings.{{ $index }}.education" type="text" class="form-control" />
                <span class="text-danger">
                    @error('siblings.' . $index . '.employer')
                        {{ $message }}
                    @enderror
                </span>
            </div>
            <div class="col-sm-2">
                ...
                <input wire:model.blur="siblings.{{ $index }}.graduation_year" type="number"
                    class="form-control" />
                <span class="text-danger">
                    @error('siblings.' . $index . '.employer')
                        {{ $message }}
            ...
            <div class="col-sm-2">
                ...
                <select wire:model.blur="siblings.{{ $index }}.get_amount" class="form-select">
                    <option hidden>{{ __('attributes.please_select') }}</option>
                    @foreach (App\Enums\GetAmount::cases() as $getAmount)
                        <option value="{{ $getAmount }}">{{ __('sibling.get_amount_name.' . $getAmount->name) }}
                        </option>
                    @endforeach
                </select>
                <span class="text-danger">
                    @error('siblings.' . $index . '.get_amount')
                        {{ $message }}
                    @enderror
                </span>
            </div>
            <div class="col-sm-4">
                ...
                <input wire:model.blur="siblings.{{ $index }}.support_site" type="text"
                    class="form-control" />
                <span class="text-danger">
                    @error('siblings.' . $index . '.support_site')
                        {{ $message }}
                    @enderror
                </span>
            </div>
