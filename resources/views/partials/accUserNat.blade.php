<div class="border rounded-lg bg-white" x-data="{ open: true }">
    ...
    <button @click="open = !open"
        ...
        <h2 class="text-lg font-medium text-gray-900">Bewerber</h2>
    ...
    <div x-show="open" class="p-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
                <p class="text-md">
                    <span class="font-medium text-gray-700">{{ __('user.nationality') }}:</span>
                    <span class="text-gray-900 ml-1">{{ $user->nationality }}</span>
                </p>
            </div>
            ...
            <div>
                <p class="text-md">
                    <span class="font-medium text-gray-700">{{ __('user.civil_status') }}:</span>
                    <span class="text-gray-900 ml-1">{{ $user->civil_status }}</span>
                </p>
            </div>
            ...
            <div>
                <p class="text-md">
                    <span class="font-medium text-gray-700">{{ __('user.soz_vers_nr') }}:</span>
                    <span class="text-gray-900 ml-1">{{ $user->soz_vers_nr }}</span>
                </p>
            </div>

            <div>
                <p class="text-md">
                    <span class="font-medium text-gray-700">{{ __('user.in_ch_since') }}:</span>
                    <span class="text-gray-900 ml-1">{{ $user->in_ch_since }}</span>
                </p>
            </div>

            <div>
                <p class="text-md">
                    <span class="font-medium text-gray-700">{{ __('user.granting') }}:</span>
                    <span class="text-gray-900 ml-1">{{ $user->granting }}</span>
                </p>
            </div>
        </div>
    </div>
